...
{ 
    public class ExpensesViewModel : BaseViewModel
    {
        ...
        public ExpensesViewModel(string title)
        {
            Title = title;
        ...
        public void CreatePieChart()
        {
            ...
            PieModel.DefaultFont = "FAS";
            PieModel.DefaultFontSize = 20;
            PieModel.DefaultColors = new List<OxyColor>
            {
                OxyColor.FromRgb(238, 230, 216),
            ...
            {
                ps.Slices.Add(new PieSlice(c.Key, c.Value) { IsExploded = false });
            }
